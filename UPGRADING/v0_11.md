...
- `lookup.spam-*` settings are no longer used, these have been replaced by `spam-filter.*` settings. Review the [updated documentation](http://nordible.co/docs/spamfilter/overview).
...
- Cache settings have changed, see the [documentation](https://nordible.co/docs/server/cache) for details.
