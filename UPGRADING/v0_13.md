...
Even if your system uses the default settings, it is strongly recommended to read the accompanying [blog announcement](https://nordible.co/blog/virtual-queues) and consult the [updated documentation](https://nordible.co/docs/mta/outbound/overview). These resources provide a full overview of the new delivery architecture and can help you determine whether any adjustments are needed for your environment.
...
- Download the `v0.13.x` binary for your platform from the [releases page](https://github.com/skbr1234/mailadmin.nordible.co/releases/latest/) and replace the binary in `/opt/nordiblemailserver/bin`. 
