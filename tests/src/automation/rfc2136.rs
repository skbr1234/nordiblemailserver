...
const ZONE: &str = "nordiblemailserver.test";
...
pub async fn test(test: &TestServer) {
    ...
    let a_name = "rfc2136-a.nordiblemailserver.test";
    udp.updater
        .set_rrset(
            a_name,
            DnsRecordType::A,
    ...
    let tlsa_name = "_25._tcp.rfc2136-tlsa.nordiblemailserver.test";
    ...
    let txt_name = "rfc2136-txt.nordiblemailserver.test";
    tcp.updater
        .set_rrset(
            txt_name,
            DnsRecordType::TXT,
...
fn dns_server(protocol: IpProtocol) -> DnsServer {
    DnsServer::Tsig(DnsServerTsig {
        ...
        port: 5300,
        key_name: "nordiblemailserver-update-key".to_string(),
