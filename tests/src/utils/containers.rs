...
const ACME_NETWORK: &str = "nordiblemailserver-test-acme";
    ...
    let container = FOUNDATIONDB
        .get_or_init(|| async {
            GenericImage::new("foundationdb/foundationdb", "7.4.6")
                ...
                .with_container_name("nordiblemailserver-test-foundationdb")
    ...
    POSTGRES
        .get_or_init(|| async {
            GenericImage::new("postgres", "16-alpine")
                ...
                .with_env_var("POSTGRES_USER", "nordiblemailserver")
                .with_env_var("POSTGRES_PASSWORD", "nordiblemailserver")
                .with_env_var("POSTGRES_DB", "nordiblemailserver")
                .with_mapped_port(5432, 5432.tcp())
                .with_startup_timeout(READY_TIMEOUT)
                .with_container_name("nordiblemailserver-test-postgres")
                .with_reuse(ReuseDirective::Always)
                .start()
                .await
    ...
    MYSQL
        .get_or_init(|| async {
            GenericImage::new("mysql", "8.0")
                ...
                .with_env_var("MYSQL_DATABASE", "nordiblemailserver")
                .with_cmd(["--default-authentication-plugin=mysql_native_password"])
                .with_mapped_port(3307, 3306.tcp())
                .with_startup_timeout(READY_TIMEOUT)
                .with_container_name("nordiblemailserver-test-mysql")
                .with_reuse(ReuseDirective::Always)
                .start()
                .await
    ...
    REDIS
        .get_or_init(|| async {
            GenericImage::new("redis", "7-alpine")
                ...
                .with_startup_timeout(READY_TIMEOUT)
                .with_container_name("nordiblemailserver-test-redis")
                .with_reuse(ReuseDirective::Always)
                .start()
                .await
...
pub async fn ensure_nats() {
    NATS.get_or_init(|| async {
        GenericImage::new("nats", "latest")
            ...
            .with_startup_timeout(READY_TIMEOUT)
            .with_container_name("nordiblemailserver-test-nats")
            .with_reuse(ReuseDirective::Always)
            .start()
            .await
    ...
    MINIO
        .get_or_init(|| async {
            GenericImage::new("minio/minio", "latest")
                ...
                .with_startup_timeout(READY_TIMEOUT)
                .with_container_name("nordiblemailserver-test-minio")
                .with_reuse(ReuseDirective::Always)
                .start()
                .await
    ...
    OPENSEARCH
        .get_or_init(|| async {
            GenericImage::new("opensearchproject/opensearch", "2")
                ...
                .with_startup_timeout(READY_TIMEOUT)
                .with_container_name("nordiblemailserver-test-opensearch")
                .with_reuse(ReuseDirective::Always)
                .start()
                .await
    ...
    MEILISEARCH
        .get_or_init(|| async {
            GenericImage::new("getmeili/meilisearch", "latest")
                ...
                .with_env_var("MEILI_MASTER_KEY", "nordiblemailserver-master-key")
                .with_mapped_port(7700, 7700.tcp())
                .with_startup_timeout(READY_TIMEOUT)
                .with_container_name("nordiblemailserver-test-meilisearch")
                .with_reuse(ReuseDirective::Always)
                .start()
                .await
    ...
    KEYCLOAK
        .get_or_init(|| async {
            GenericImage::new("quay.io/keycloak/keycloak", "latest")
                ...
                .with_copy_to(
                    "/opt/keycloak/data/import/nordiblemailserver-realm.json",
                    include_bytes!("../../docker/keycloak/nordiblemailserver-realm.json").to_vec(),
                )
                .with_mapped_port(9080, 9080.tcp())
                .with_startup_timeout(READY_TIMEOUT)
                .with_container_name("nordiblemailserver-test-keycloak")
                .with_reuse(ReuseDirective::Always)
                .start()
                .await
        ...
        .await;
    wait_for_http("http://localhost:9080/realms/nordiblemailserver/.well-known/openid-configuration").await;
}
...
async fn ensure_challtestsrv() {
    CHALLTESTSRV
        .get_or_init(|| async {
            let image = GenericBuildableImage::new("nordiblemailserver-test-challtestsrv", "local")
            ...
            image
                ...
                .with_startup_timeout(READY_TIMEOUT)
                .with_container_name("nordiblemailserver-test-challtestsrv")
                .with_reuse(ReuseDirective::Always)
                .start()
                .await
        ...
        .get_or_init(|| async {
            GenericImage::new("ghcr.io/letsencrypt/pebble", "latest")
                ...
                .with_cmd([
                    ...
                    "-dnsserver",
                    "nordiblemailserver-test-challtestsrv:8053",
                ])
                .with_copy_to(
                    "/test/config/pebble-config.json",
                ...
                .with_startup_timeout(READY_TIMEOUT)
                .with_container_name("nordiblemailserver-test-pebble")
                .with_reuse(ReuseDirective::Always)
                .start()
                .await
    ...
    let container = POWERDNS
        .get_or_init(|| async {
            GenericImage::new("powerdns/pdns-auth-49", "latest")
                ...
                .with_env_var("PDNS_AUTH_API_KEY", "nordiblemailserver-api-key")
                .with_copy_to(
                    "/etc/powerdns/pdns.d/nordiblemailserver.conf",
                    include_bytes!("../../docker/powerdns/pdns.conf").to_vec(),
                )
                .with_mapped_port(5300, 53.tcp())
                .with_mapped_port(5300, 53.udp())
                .with_startup_timeout(READY_TIMEOUT)
                .with_container_name("nordiblemailserver-test-powerdns")
                .with_reuse(ReuseDirective::Always)
                .start()
                .await
    ...
    OPENLDAP
        .get_or_init(|| async {
            GenericImage::new("osixia/openldap", "1.5.0")
                ...
                .with_env_var("LDAP_ORGANISATION", "NordibleMailServer Test")
                .with_env_var("LDAP_DOMAIN", "nordiblemailserver.test")
                .with_env_var("LDAP_BASE_DN", "dc=nordiblemailserver,dc=test")
                ...
                .with_startup_timeout(READY_TIMEOUT)
                .with_container_name("nordiblemailserver-test-openldap")
                .with_reuse(ReuseDirective::Always)
                .start()
                .await
