#!/usr/bin/env python3
"""
NordibleMailServer SEL code remover

This script removes SEL code from the NordibleMailServer codebase by:
...
Usage: python ossify.py <nordiblemailserver_repository>/crates
"""
...
def main():
    parser = argparse.ArgumentParser(
        description='Remove Enterprise licensed code from NordibleMailServer codebase'
    )
    parser.add_argument(
        'directory',
        help='Directory containing NordibleMailServer code to process'
    )
    parser.add_argument(
        '--dry-run',
        action='store_true',
