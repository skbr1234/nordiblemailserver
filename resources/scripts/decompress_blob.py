#!/usr/bin/env python3
"""Decode a raw NordibleMailServer blob object into its original bytes.

NordibleMailServer appends a one-byte compression marker to every blob it writes to the
