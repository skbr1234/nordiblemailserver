...
NordibleMailServer reference-counts blobs through link entries kept in the data store
...
def main():
    ...
    ap.add_argument("--user", default=os.environ.get("PGUSER", "nordiblemailserver"))
    ap.add_argument("--password", default=os.environ.get("PGPASSWORD", "nordiblemailserver"))
    ap.add_argument("--dbname", default=os.environ.get("PGDATABASE", "nordiblemailserver"))
