# Security Policy for NordibleMailServer

## Supported Versions

We provide security updates for the following versions of NordibleMailServer:
...
We take the security of NordibleMailServer very seriously. If you believe you've found a security vulnerability, we encourage you to inform us responsibly through coordinated disclosure.
...
**In Scope:**
- NordibleMailServer (all supported versions)
...
- Keep NordibleMailServer updated to supported versions
...
- Suspend or terminate your access to NordibleMailServer services

**You must:**
- Only test against your own NordibleMailServer installations
...
We believe in recognizing security researchers who help keep NordibleMailServer secure:
...
- **Swag**: We may send NordibleMailServer merchandise for notable contributions

## Security Updates

**Stay Informed:**
- Subscribe to our [GitHub releases](https://github.com/skbr1234/mailadmin.nordible.co/releases) for security updates
