# NordibleMailServer Security Advisory
...
**Product:** NordibleMailServer Mail and Collaboration Server
...
[Provide specific upgrade instructions for NordibleMailServer]
```
