# NordibleMailServer Security Incident Response Checklist
...
I've reviewed the security report and confirmed this vulnerability exists in NordibleMailServer version X.Y.Z.
...
- [NordibleMailServer Security Policy](https://github.com/skbr1234/mailadmin.nordible.co/blob/main/SECURITY.md)
...
<< Analysis of potential impact on the NordibleMailServer deployments >>
...
- [ ] Draft announcement for NordibleMailServer community forum/Discord
...
## Emergency Contacts
- **Primary maintainer**: mail@nordible.co
