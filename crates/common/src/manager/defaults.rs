        ...
        bp.registry
            .write(RegistryWrite::insert(
                &Application {
                    ...
                    description: "NordibleMailServer Web Interface".to_string(),
                    enabled: true,
                    #[cfg(not(feature = "dev_mode"))]
                    resource_url:
                        "https://email.nordible.co/assets/webui.zip"
                            .into(),
        ...
        bp.registry
            .write(RegistryWrite::insert(
                &Tracer::Log(TracerLog {
                    enable: true,
                    ansi: false,
                    prefix: "nordiblemailserver.log".into(),
                    rotate: LogRotateFrequency::Daily,
                    path: "/var/log/nordiblemailserver".into(),
                    ..Default::default()
                })
                .into(),
            ))
