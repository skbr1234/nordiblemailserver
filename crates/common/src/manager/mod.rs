...
pub const SPAM_TRAINER_KEY: &[u8] = "NORDIBLEMAILSERVER_SPAM_TRAIN_DATA.lz4".as_bytes();
pub const SPAM_CLASSIFIER_KEY: &[u8] = "NORDIBLEMAILSERVER_SPAM_CLASSIFIER_MODEL.lz4".as_bytes();
