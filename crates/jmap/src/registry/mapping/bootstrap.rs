                ...
                set.response.not_updated.append(
                    ...
                    SetError::invalid_properties()
                        ...
                        .with_description(concat!(
                            ...
                            "https://github.com/skbr1234/mailadmin.nordible.co/blob/main/UPGRADING/v0_16.md"
                        )),
                );
                break;
            }
...
fn build_default_bootstrap(server: &Server) -> Bootstrap {
    ...
    Bootstrap {
        data_store: DataStore::RocksDb(RocksDbStore {
            path: "/var/lib/nordiblemailserver/".to_string(),
            ..Default::default()
        }),
        ...
        tracer: Tracer::Log(TracerLog {
            path: "/var/log/nordiblemailserver/".to_string(),
            prefix: "nordiblemailserver".to_string(),
            ansi: true,
            enable: true,
            ..Default::default()
        }),
