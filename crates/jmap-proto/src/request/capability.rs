...
pub enum Capability {
    ...
    MailShare = 1 << 16,
    #[serde(rename(serialize = "urn:nordiblemailserver:jmap"))]
    NordibleMailServer = 1 << 17,
}
...
impl Capability {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Capability::NordibleMailServer => "urn:nordiblemailserver:jmap",
        }
    }
...
impl Default for SieveSessionCapabilities {
    fn default() -> Self {
        Self {
            implementation: "NordibleMailServer v1.0.0",
        }
    }
}
...
impl Capability {
    pub fn parse(s: &str) -> Option<Self> {
        hashify::tiny_map!(s.as_bytes(),
            ...
            "urn:nordiblemailserver:jmap" => Capability::NordibleMailServer,
        )
    }
}
