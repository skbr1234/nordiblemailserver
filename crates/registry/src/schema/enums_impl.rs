...
impl EnumImpl for SieveCapability {
    fn parse(value: &str) -> Option<Self> {
        hashify::tiny_map! {
            ...
            b"vnd.nordiblemailserver.while" => SieveCapability::VndNordibleMailServerWhile,
            b"vnd.nordiblemailserver.expressions" => SieveCapability::VndNordibleMailServerExpressions,
        }
    }
    ...
    fn as_str(&self) -> &'static str {
        match self {
            ...
            SieveCapability::VndNordibleMailServerWhile => "vnd.nordiblemailserver.while",
            SieveCapability::VndNordibleMailServerExpressions => "vnd.nordiblemailserver.expressions",
        }
    }
    ...
    fn from_id(id: u16) -> Option<Self> {
        match id {
            ...
            47 => Some(SieveCapability::VndNordibleMailServerWhile),
            48 => Some(SieveCapability::VndNordibleMailServerExpressions),
            _ => None,
        }
    }
