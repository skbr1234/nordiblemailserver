        ...
        inner.store = match inner.read_data_store().await {
            ...
            RegistryInit::Bootstrap => {
                ...
                if inner.env_recovery_admin.is_none() {
                    ...
                    eprintln!();
                    eprintln!("════════════════════════════════════════════════════════════");
                    eprintln!("🔑 NordibleMailServer bootstrap mode - temporary administrator account");
                    eprintln!();
                    eprintln!("   username: admin");
                    eprintln!("   password: {password}");
                    eprintln!();
                    eprintln!("Use these credentials to complete the initial setup at the");
                    eprintln!("/admin web UI. Once setup is done, NordibleMailServer will provision a");
                    ...
                    eprintln!("instead, set NORDIBLEMAILSERVER_RECOVERY_ADMIN=admin:<password> in the");
                    eprintln!("env file.");
                    eprintln!("════════════════════════════════════════════════════════════");
                    eprintln!();
